...
-- Translated     : 2026-07-15 15:36:55 CEST
...
window_l01 AS (
    SELECT
        ...
        MAX(
            CASE
                WHEN le.event_date >= (wb.anchor_date + 30 * wb.window_index*INTERVAL'1 day')
                 AND le.event_date <  (wb.anchor_date + 30 * (wb.window_index + 1)*INTERVAL'1 day')
                THEN 1 ELSE 0
            END
...
window_denom AS (
    SELECT
        ...
        MAX(
            CASE
                WHEN op.observation_period_start_date <= (wb.anchor_date + 30 * wb.window_index + 15*INTERVAL'1 day')
                 AND op.observation_period_end_date   >= (wb.anchor_date + 30 * wb.window_index + 15*INTERVAL'1 day')
                THEN 1 ELSE 0
            END
