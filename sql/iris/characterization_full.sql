...
------------------------------------------------------------
DROP TABLE IF EXISTS ldpw47q6dx_anchor_include;
DROP TABLE IF EXISTS ldpw47q6dx_anchor_include ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6dx_anchor_include  (concept_id BIGINT NOT NULL,
    include_descendants SMALLINT NOT NULL
);
INSERT INTO ldpw47q6dx_anchor_include (concept_id, include_descendants) VALUES
...
;
DROP TABLE IF EXISTS ldpw47q6dx_anchor_exclude;
DROP TABLE IF EXISTS ldpw47q6dx_anchor_exclude ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6dx_anchor_exclude  (concept_id BIGINT NOT NULL,
    include_descendants SMALLINT NOT NULL
);
INSERT INTO ldpw47q6dx_anchor_exclude (concept_id, include_descendants) VALUES
    (4280899, 1),
    (4289374, 1),
    (4280900, 1),
    (4283614, 1),
    ...
    (4280897, 1),
    (4200889, 1);
DROP TABLE IF EXISTS ldpw47q6dx_anchor_concepts;
DROP TABLE IF EXISTS ldpw47q6dx_anchor_concepts ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6dx_anchor_concepts  (concept_id BIGINT
);
...
------------------------------------------------------------
DROP TABLE IF EXISTS ldpw47q6gen_cancer_concepts;
DROP TABLE IF EXISTS ldpw47q6gen_cancer_concepts ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6gen_cancer_concepts  (concept_id BIGINT
);
...
------------------------------------------------------------
DROP TABLE IF EXISTS ldpw47q6other_dx_ancestor_concepts;
DROP TABLE IF EXISTS ldpw47q6other_dx_ancestor_concepts ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6other_dx_ancestor_concepts  (ancestor_concept_id BIGINT
);
-- EDIT THIS LIST
...
;
DROP TABLE IF EXISTS ldpw47q6other_dx_concepts;
DROP TABLE IF EXISTS ldpw47q6other_dx_concepts ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6other_dx_concepts  (concept_id BIGINT
);
...
------------------------------------------------------------
DROP TABLE IF EXISTS ldpw47q6met_ancestor_concepts;
DROP TABLE IF EXISTS ldpw47q6met_ancestor_concepts ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6met_ancestor_concepts  (ancestor_concept_id BIGINT
);
-- Default: concept set "Secondary malignancy" from cohort_definitions/Target_Cohort_2B.json
INSERT INTO ldpw47q6met_ancestor_concepts (ancestor_concept_id)
VALUES
    (1633308),  -- AJCC/UICC Stage 4
    (1635142),  -- AJCC/UICC M1 Category
    (36769180)  -- Metastasis
;
DROP TABLE IF EXISTS ldpw47q6met_concepts;
DROP TABLE IF EXISTS ldpw47q6met_concepts ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6met_concepts  (concept_id BIGINT
);
...
------------------------------------------------------------
DROP TABLE IF EXISTS ldpw47q6l01_ancestor_concepts;
DROP TABLE IF EXISTS ldpw47q6l01_ancestor_concepts ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6l01_ancestor_concepts  (ancestor_concept_id BIGINT
);
-- EDIT THIS LIST
...
VALUES
    (21601387)
;
DROP TABLE IF EXISTS ldpw47q6l01_concepts;
DROP TABLE IF EXISTS ldpw47q6l01_concepts ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6l01_concepts  (concept_id BIGINT
);
...
-- F) EVENT TABLES
------------------------------------------------------------
DROP TABLE IF EXISTS ldpw47q6dx_events;
DROP TABLE IF EXISTS ldpw47q6dx_events ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6dx_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS ldpw47q6anchor_person;
DROP TABLE IF EXISTS ldpw47q6anchor_person ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6anchor_person  (person_id BIGINT
);
INSERT INTO ldpw47q6anchor_person (person_id)
SELECT DISTINCT person_id
FROM ldpw47q6dx_events
;
DROP TABLE IF EXISTS ldpw47q6other_dx_events;
DROP TABLE IF EXISTS ldpw47q6other_dx_events ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6other_dx_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
JOIN ldpw47q6other_dx_concepts d
  ON co.condition_concept_id = d.concept_id
;
DROP TABLE IF EXISTS ldpw47q6gen_cancer_events;
DROP TABLE IF EXISTS ldpw47q6gen_cancer_events ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6gen_cancer_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
;
DROP TABLE IF EXISTS ldpw47q6met_events;
DROP TABLE IF EXISTS ldpw47q6met_events ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6met_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
;
DROP TABLE IF EXISTS ldpw47q6l01_events;
DROP TABLE IF EXISTS ldpw47q6l01_events ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6l01_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS ldpw47q6l01_ingredient_events;
DROP TABLE IF EXISTS ldpw47q6l01_ingredient_events ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6l01_ingredient_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
------------------------------------------------------------
DROP TABLE IF EXISTS ldpw47q6cohort;
DROP TABLE IF EXISTS ldpw47q6cohort ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6cohort  (person_id BIGINT,
    index_date DATE
);
...
GROUP BY person_id
;
DROP TABLE IF EXISTS ldpw47q6dx_summary;
DROP TABLE IF EXISTS ldpw47q6dx_summary ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6dx_summary  (person_id BIGINT,
    n_dx_records INT,
    n_dx_codes INT
);
...
;
DROP TABLE IF EXISTS ldpw47q6other_dx_summary;
DROP TABLE IF EXISTS ldpw47q6other_dx_summary ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6other_dx_summary  (person_id BIGINT,
...
GROUP BY e.person_id
;
DROP TABLE IF EXISTS ldpw47q6gen_cancer_summary;
DROP TABLE IF EXISTS ldpw47q6gen_cancer_summary ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6gen_cancer_summary  (person_id BIGINT,
...
GROUP BY e.person_id
;
DROP TABLE IF EXISTS ldpw47q6met_summary;
DROP TABLE IF EXISTS ldpw47q6met_summary ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6met_summary  (person_id BIGINT,
    first_met_date DATE,
    n_met_records INT
);
...
GROUP BY e.person_id
;
DROP TABLE IF EXISTS ldpw47q6l01_summary;
DROP TABLE IF EXISTS ldpw47q6l01_summary ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6l01_summary  (person_id BIGINT,
    first_l01_date DATE,
    n_l01_exposures INT
);
...
------------------------------------------------------------
DROP TABLE IF EXISTS ldpw47q6event_code_counts;
DROP TABLE IF EXISTS ldpw47q6event_code_counts ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6event_code_counts  (anchor_event VARCHAR(20), -- INDEX or FIRST_MET
...
GROUP BY concept_id
;
DROP TABLE IF EXISTS ldpw47q6event_code_counts_before_after;
DROP TABLE IF EXISTS ldpw47q6event_code_counts_before_after ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6event_code_counts_before_after  (anchor_event VARCHAR(20), -- INDEX
    event_family VARCHAR(20),
...
GROUP BY
    ...
    e.concept_id
;
DROP TABLE IF EXISTS ldpw47q6event_code_counts_before_after_first_met;
DROP TABLE IF EXISTS ldpw47q6event_code_counts_before_after_first_met ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6event_code_counts_before_after_first_met  (anchor_event VARCHAR(20), -- FIRST_MET
    event_family VARCHAR(20),
...
GROUP BY
    ...
    e.concept_id
;
DROP TABLE IF EXISTS ldpw47q6event_code_all_events;
DROP TABLE IF EXISTS ldpw47q6event_code_all_events ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6event_code_all_events  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT,
...
WHERE ms.first_met_date IS NOT NULL
;
DROP TABLE IF EXISTS ldpw47q6event_code_patient_chosen_first;
DROP TABLE IF EXISTS ldpw47q6event_code_patient_chosen_first ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6event_code_patient_chosen_first  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT
...
WHERE rn = 1
;
DROP TABLE IF EXISTS ldpw47q6event_code_patient_chosen_closest;
DROP TABLE IF EXISTS ldpw47q6event_code_patient_chosen_closest ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6event_code_patient_chosen_closest  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT
...
WHERE rn = 1
;
DROP TABLE IF EXISTS ldpw47q6event_code_timing_summary;
DROP TABLE IF EXISTS ldpw47q6event_code_timing_summary ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6event_code_timing_summary  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
...
;
DROP TABLE IF EXISTS ldpw47q6event_code_ba_events;
DROP TABLE IF EXISTS ldpw47q6event_code_ba_events ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6event_code_ba_events  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
...
FROM ldpw47q6event_code_all_events
;
DROP TABLE IF EXISTS ldpw47q6event_code_patient_chosen_before_after_first;
DROP TABLE IF EXISTS ldpw47q6event_code_patient_chosen_before_after_first ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6event_code_patient_chosen_before_after_first  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    person_id BIGINT,
...
WHERE rn = 1
;
DROP TABLE IF EXISTS ldpw47q6event_code_patient_chosen_before_after_closest;
DROP TABLE IF EXISTS ldpw47q6event_code_patient_chosen_before_after_closest ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6event_code_patient_chosen_before_after_closest  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    person_id BIGINT,
...
WHERE rn = 1
;
DROP TABLE IF EXISTS ldpw47q6event_code_timing_before_after_summary;
DROP TABLE IF EXISTS ldpw47q6event_code_timing_before_after_summary ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6event_code_timing_before_after_summary  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    n_patients_with_code_timing INT,
...
------------------------------------------------------------
DROP TABLE IF EXISTS ldpw47q6patient_char;
DROP TABLE IF EXISTS ldpw47q6patient_char ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6patient_char  (person_id BIGINT,
    index_date DATE,
    n_dx_records INT,
    n_dx_codes INT,
    first_other_dx_date DATE,
...
------------------------------------------------------------
DROP TABLE IF EXISTS ldpw47q6patient_timing_pairs;
DROP TABLE IF EXISTS ldpw47q6patient_timing_pairs ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6patient_timing_pairs  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
WITH events AS (
    SELECT person_id, 'DX' AS event_name, index_date AS event_date FROM ldpw47q6patient_char
    UNION ALL
...
;
DROP TABLE IF EXISTS ldpw47q6timing_pair_summary;
DROP TABLE IF EXISTS ldpw47q6timing_pair_summary ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6timing_pair_summary  (from_event VARCHAR(10),
    to_event VARCHAR(10),
...
;
DROP TABLE IF EXISTS ldpw47q6all_events_for_pairs;
DROP TABLE IF EXISTS ldpw47q6all_events_for_pairs ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6all_events_for_pairs  (person_id BIGINT,
...
;
DROP TABLE IF EXISTS ldpw47q6first_event_dates;
DROP TABLE IF EXISTS ldpw47q6first_event_dates ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6first_event_dates  (person_id BIGINT,
    from_event VARCHAR(10),
...
;
DROP TABLE IF EXISTS ldpw47q6patient_timing_pairs_first_to_closest;
DROP TABLE IF EXISTS ldpw47q6patient_timing_pairs_first_to_closest ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6patient_timing_pairs_first_to_closest  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
WHERE rn = 1
;
DROP TABLE IF EXISTS ldpw47q6timing_pair_summary_first_to_closest;
DROP TABLE IF EXISTS ldpw47q6timing_pair_summary_first_to_closest ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6timing_pair_summary_first_to_closest  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
GROUP BY from_event, to_event
;
DROP TABLE IF EXISTS ldpw47q6patient_timing_pairs_first_to_closest_before;
DROP TABLE IF EXISTS ldpw47q6patient_timing_pairs_first_to_closest_before ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6patient_timing_pairs_first_to_closest_before  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
WHERE rn = 1
;
DROP TABLE IF EXISTS ldpw47q6timing_pair_summary_first_to_closest_before;
DROP TABLE IF EXISTS ldpw47q6timing_pair_summary_first_to_closest_before ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6timing_pair_summary_first_to_closest_before  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
GROUP BY from_event, to_event
;
DROP TABLE IF EXISTS ldpw47q6patient_timing_pairs_first_to_closest_after;
DROP TABLE IF EXISTS ldpw47q6patient_timing_pairs_first_to_closest_after ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6patient_timing_pairs_first_to_closest_after  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
WHERE rn = 1
;
DROP TABLE IF EXISTS ldpw47q6timing_pair_summary_first_to_closest_after;
DROP TABLE IF EXISTS ldpw47q6timing_pair_summary_first_to_closest_after ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6timing_pair_summary_first_to_closest_after  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
GROUP BY from_event, to_event
;
DROP TABLE IF EXISTS ldpw47q6event_presence;
DROP TABLE IF EXISTS ldpw47q6event_presence ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6event_presence  (person_id BIGINT,
    has_dx INT,
    has_odx INT,
    has_gdx INT,
    has_met INT,
...
DROP TABLE IF EXISTS ldpw47q6death_obs_status;
DROP TABLE IF EXISTS ldpw47q6death_obs_status ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6death_obs_status  (person_id BIGINT,
    death_date DATE,
...
;
DROP TABLE IF EXISTS ldpw47q6death_index_long;
DROP TABLE IF EXISTS ldpw47q6death_index_long ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6death_index_long  (prevalence_year VARCHAR(20),
    days_to_death INT
);
...
WHERE dos.death_date >= c.index_date
;
DROP TABLE IF EXISTS ldpw47q6death_first_met_long;
DROP TABLE IF EXISTS ldpw47q6death_first_met_long ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6death_first_met_long  (prevalence_year VARCHAR(20),
    days_to_death INT
);
...
WHERE dos.death_date >= ms.first_met_date
;
DROP TABLE IF EXISTS ldpw47q6death_stratum_counts;
DROP TABLE IF EXISTS ldpw47q6death_stratum_counts ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6death_stratum_counts  (prevalence_year VARCHAR(20),
...
GROUP BY GROUPING SETS ((), (YEAR(c.index_date)))
;
DROP TABLE IF EXISTS ldpw47q6death_timing_long;
DROP TABLE IF EXISTS ldpw47q6death_timing_long ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6death_timing_long  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    days_to_death INT
);
...
;
DROP TABLE IF EXISTS ldpw47q6death_timing_quantiles;
DROP TABLE IF EXISTS ldpw47q6death_timing_quantiles ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6death_timing_quantiles  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    lq_days FLOAT,
    median_days FLOAT,
    uq_days FLOAT
...
DROP TABLE IF EXISTS ldpw47q6followup_long;
DROP TABLE IF EXISTS ldpw47q6followup_long ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6followup_long  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    followup_days INT
);
...
;
DROP TABLE IF EXISTS ldpw47q6followup_quantiles;
DROP TABLE IF EXISTS ldpw47q6followup_quantiles ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6followup_quantiles  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
...
DROP TABLE IF EXISTS ldpw47q6l01_event_days;
DROP TABLE IF EXISTS ldpw47q6l01_event_days ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6l01_event_days  (person_id  BIGINT,
    event_day  DATE
);
...
DROP TABLE IF EXISTS ldpw47q6l01_consecutive_gaps;
DROP TABLE IF EXISTS ldpw47q6l01_consecutive_gaps ; CREATE GLOBAL TEMPORARY TABLE ldpw47q6l01_consecutive_gaps  (person_id  BIGINT,
    subgroup   VARCHAR(10),
    gap_days   INT
);
WITH ranked AS (
...
FROM (
    SELECT 'first_to_first'          AS timing_type, from_event, to_event, n_patients_with_pair, p05_days, p10_days, p20_days, p25_days, p30_days, p40_days, p50_days, p60_days, p70_days, p75_days, p80_days, p90_days, p95_days FROM ldpw47q6timing_pair_summary
    UNION ALL
    SELECT 'first_to_closest'        AS timing_type, from_event, to_event, n_patients_with_pair, p05_days, p10_days, p20_days, p25_days, p30_days, p40_days, p50_days, p60_days, p70_days, p75_days, p80_days, p90_days, p95_days FROM ldpw47q6timing_pair_summary_first_to_closest
    UNION ALL
    SELECT 'first_to_closest_before' AS timing_type, from_event, to_event, n_patients_with_pair, p05_days, p10_days, p20_days, p25_days, p30_days, p40_days, p50_days, p60_days, p70_days, p75_days, p80_days, p90_days, p95_days FROM ldpw47q6timing_pair_summary_first_to_closest_before
    UNION ALL
    SELECT 'first_to_closest_after'  AS timing_type, from_event, to_event, n_patients_with_pair, p05_days, p10_days, p20_days, p25_days, p30_days, p40_days, p50_days, p60_days, p70_days, p75_days, p80_days, p90_days, p95_days FROM ldpw47q6timing_pair_summary_first_to_closest_after
) x
