...
-- Target dialect : iris
-- Translated     : 2026-07-15 15:37:53 CEST
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdx_anchor_include  (concept_id BIGINT NOT NULL,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdx_anchor_exclude  (concept_id BIGINT NOT NULL,
    include_descendants SMALLINT NOT NULL
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdx_anchor_concepts  (concept_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zgen_cancer_concepts  (concept_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zother_dx_ancestor_concepts  (ancestor_concept_id BIGINT
);
-- EDIT THIS LIST
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zother_dx_concepts  (concept_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zmet_ancestor_concepts  (ancestor_concept_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zmet_concepts  (concept_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zl01_ancestor_concepts  (ancestor_concept_id BIGINT
);
-- EDIT THIS LIST
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zl01_concepts  (concept_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdtp_ancestor_concepts  (ancestor_concept_id BIGINT
);
-- EDIT THIS LIST
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdtp_concepts  (concept_id      BIGINT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdx_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zanchor_person  (person_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zother_dx_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zgen_cancer_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zmet_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zl01_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zl01_ingredient_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zcohort_attrition  (stage      VARCHAR(50),
    n_patients INT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zcohort  (person_id BIGINT,
    index_date DATE
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdx_summary  (person_id BIGINT,
    n_dx_records INT,
    n_dx_codes INT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zother_dx_summary  (person_id BIGINT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zgen_cancer_summary  (person_id BIGINT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zmet_summary  (person_id BIGINT,
    first_met_date DATE,
    n_met_records INT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zl01_summary  (person_id BIGINT,
    first_l01_date DATE,
    n_l01_exposures INT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zevent_code_counts  (anchor_event VARCHAR(20), -- INDEX or FIRST_MET
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zevent_code_counts_before_after  (anchor_event VARCHAR(20), -- INDEX
    event_family VARCHAR(20),
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zevent_code_counts_before_after_first_met  (anchor_event VARCHAR(20), -- FIRST_MET
    event_family VARCHAR(20),
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zevent_code_all_events  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zevent_code_patient_chosen_first  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zevent_code_patient_chosen_closest  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zevent_code_timing_summary  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zevent_code_ba_events  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zevent_code_patient_chosen_before_after_first  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    person_id BIGINT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zevent_code_patient_chosen_before_after_closest  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    person_id BIGINT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zevent_code_timing_before_after_summary  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    n_patients_with_code_timing INT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zpatient_char  (person_id BIGINT,
    index_date DATE,
    n_dx_records INT,
    n_dx_codes INT,
    first_other_dx_date DATE,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zpatient_timing_pairs  (person_id BIGINT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4ztiming_pair_summary  (from_event VARCHAR(10),
    to_event VARCHAR(10),
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zall_events_for_pairs  (person_id BIGINT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zfirst_event_dates  (person_id BIGINT,
    from_event VARCHAR(10),
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zpatient_timing_pairs_first_to_closest  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4ztiming_pair_summary_first_to_closest  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zpatient_timing_pairs_first_to_closest_before  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4ztiming_pair_summary_first_to_closest_before  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zpatient_timing_pairs_first_to_closest_after  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4ztiming_pair_summary_first_to_closest_after  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zevent_presence  (person_id BIGINT,
    has_dx INT,
    has_odx INT,
    has_gdx INT,
    has_met INT,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdeath_obs_status  (person_id BIGINT,
    death_date DATE,
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdeath_index_long  (prevalence_year VARCHAR(20),
    days_to_death INT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdeath_first_met_long  (prevalence_year VARCHAR(20),
    days_to_death INT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdeath_stratum_counts  (prevalence_year VARCHAR(20),
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdeath_timing_long  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    days_to_death INT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zdeath_timing_quantiles  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    lq_days FLOAT,
    median_days FLOAT,
    uq_days FLOAT
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zfollowup_long  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    followup_days INT
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zfollowup_quantiles  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zl01_event_days  (person_id  BIGINT,
    event_day  DATE
);
...
CREATE GLOBAL TEMPORARY TABLE vcbo5u4zl01_consecutive_gaps  (person_id  BIGINT,
    subgroup   VARCHAR(12),
    gap_days   INT
);
WITH ranked AS (
