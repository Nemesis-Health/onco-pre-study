...
DROP TABLE IF EXISTS cbse36ibdx_anchor_include ; CREATE GLOBAL TEMPORARY TABLE cbse36ibdx_anchor_include  (concept_id BIGINT NOT NULL,
...
DROP TABLE IF EXISTS cbse36ibdx_anchor_exclude ; CREATE GLOBAL TEMPORARY TABLE cbse36ibdx_anchor_exclude  (concept_id BIGINT NOT NULL,
    include_descendants SMALLINT NOT NULL
);
...
DROP TABLE IF EXISTS cbse36ibdx_anchor_concepts ; CREATE GLOBAL TEMPORARY TABLE cbse36ibdx_anchor_concepts  (concept_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibgen_cancer_concepts ; CREATE GLOBAL TEMPORARY TABLE cbse36ibgen_cancer_concepts  (concept_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibother_dx_ancestor_concepts ; CREATE GLOBAL TEMPORARY TABLE cbse36ibother_dx_ancestor_concepts  (ancestor_concept_id BIGINT
);
-- EDIT THIS LIST
...
DROP TABLE IF EXISTS cbse36ibother_dx_concepts ; CREATE GLOBAL TEMPORARY TABLE cbse36ibother_dx_concepts  (concept_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibmet_ancestor_concepts ; CREATE GLOBAL TEMPORARY TABLE cbse36ibmet_ancestor_concepts  (ancestor_concept_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibmet_concepts ; CREATE GLOBAL TEMPORARY TABLE cbse36ibmet_concepts  (concept_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibl01_ancestor_concepts ; CREATE GLOBAL TEMPORARY TABLE cbse36ibl01_ancestor_concepts  (ancestor_concept_id BIGINT
);
-- EDIT THIS LIST
...
DROP TABLE IF EXISTS cbse36ibl01_concepts ; CREATE GLOBAL TEMPORARY TABLE cbse36ibl01_concepts  (concept_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibdx_events ; CREATE GLOBAL TEMPORARY TABLE cbse36ibdx_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibanchor_person ; CREATE GLOBAL TEMPORARY TABLE cbse36ibanchor_person  (person_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibother_dx_events ; CREATE GLOBAL TEMPORARY TABLE cbse36ibother_dx_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibgen_cancer_events ; CREATE GLOBAL TEMPORARY TABLE cbse36ibgen_cancer_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibmet_events ; CREATE GLOBAL TEMPORARY TABLE cbse36ibmet_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibl01_events ; CREATE GLOBAL TEMPORARY TABLE cbse36ibl01_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibl01_ingredient_events ; CREATE GLOBAL TEMPORARY TABLE cbse36ibl01_ingredient_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS cbse36ibcohort ; CREATE GLOBAL TEMPORARY TABLE cbse36ibcohort  (person_id BIGINT,
    index_date DATE
);
...
DROP TABLE IF EXISTS cbse36ibdx_summary ; CREATE GLOBAL TEMPORARY TABLE cbse36ibdx_summary  (person_id BIGINT,
    n_dx_records INT,
    n_dx_codes INT
);
...
DROP TABLE IF EXISTS cbse36ibother_dx_summary ; CREATE GLOBAL TEMPORARY TABLE cbse36ibother_dx_summary  (person_id BIGINT,
...
DROP TABLE IF EXISTS cbse36ibgen_cancer_summary ; CREATE GLOBAL TEMPORARY TABLE cbse36ibgen_cancer_summary  (person_id BIGINT,
...
DROP TABLE IF EXISTS cbse36ibmet_summary ; CREATE GLOBAL TEMPORARY TABLE cbse36ibmet_summary  (person_id BIGINT,
    first_met_date DATE,
    n_met_records INT
);
...
DROP TABLE IF EXISTS cbse36ibl01_summary ; CREATE GLOBAL TEMPORARY TABLE cbse36ibl01_summary  (person_id BIGINT,
    first_l01_date DATE,
    n_l01_exposures INT
);
...
DROP TABLE IF EXISTS cbse36ibevent_code_counts ; CREATE GLOBAL TEMPORARY TABLE cbse36ibevent_code_counts  (anchor_event VARCHAR(20), -- INDEX or FIRST_MET
...
DROP TABLE IF EXISTS cbse36ibevent_code_counts_before_after ; CREATE GLOBAL TEMPORARY TABLE cbse36ibevent_code_counts_before_after  (anchor_event VARCHAR(20), -- INDEX
    event_family VARCHAR(20),
...
DROP TABLE IF EXISTS cbse36ibevent_code_counts_before_after_first_met ; CREATE GLOBAL TEMPORARY TABLE cbse36ibevent_code_counts_before_after_first_met  (anchor_event VARCHAR(20), -- FIRST_MET
    event_family VARCHAR(20),
...
DROP TABLE IF EXISTS cbse36ibevent_code_all_events ; CREATE GLOBAL TEMPORARY TABLE cbse36ibevent_code_all_events  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT,
...
DROP TABLE IF EXISTS cbse36ibevent_code_patient_chosen_first ; CREATE GLOBAL TEMPORARY TABLE cbse36ibevent_code_patient_chosen_first  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT
...
DROP TABLE IF EXISTS cbse36ibevent_code_patient_chosen_closest ; CREATE GLOBAL TEMPORARY TABLE cbse36ibevent_code_patient_chosen_closest  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT
...
DROP TABLE IF EXISTS cbse36ibevent_code_timing_summary ; CREATE GLOBAL TEMPORARY TABLE cbse36ibevent_code_timing_summary  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
...
DROP TABLE IF EXISTS cbse36ibevent_code_ba_events ; CREATE GLOBAL TEMPORARY TABLE cbse36ibevent_code_ba_events  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
...
DROP TABLE IF EXISTS cbse36ibevent_code_patient_chosen_before_after_first ; CREATE GLOBAL TEMPORARY TABLE cbse36ibevent_code_patient_chosen_before_after_first  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    person_id BIGINT,
...
DROP TABLE IF EXISTS cbse36ibevent_code_patient_chosen_before_after_closest ; CREATE GLOBAL TEMPORARY TABLE cbse36ibevent_code_patient_chosen_before_after_closest  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    person_id BIGINT,
...
DROP TABLE IF EXISTS cbse36ibevent_code_timing_before_after_summary ; CREATE GLOBAL TEMPORARY TABLE cbse36ibevent_code_timing_before_after_summary  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    n_patients_with_code_timing INT,
...
DROP TABLE IF EXISTS cbse36ibpatient_char ; CREATE GLOBAL TEMPORARY TABLE cbse36ibpatient_char  (person_id BIGINT,
    index_date DATE,
    n_dx_records INT,
    n_dx_codes INT,
    first_other_dx_date DATE,
...
DROP TABLE IF EXISTS cbse36ibpatient_timing_pairs ; CREATE GLOBAL TEMPORARY TABLE cbse36ibpatient_timing_pairs  (person_id BIGINT,
...
DROP TABLE IF EXISTS cbse36ibtiming_pair_summary ; CREATE GLOBAL TEMPORARY TABLE cbse36ibtiming_pair_summary  (from_event VARCHAR(10),
    to_event VARCHAR(10),
...
DROP TABLE IF EXISTS cbse36iball_events_for_pairs ; CREATE GLOBAL TEMPORARY TABLE cbse36iball_events_for_pairs  (person_id BIGINT,
...
DROP TABLE IF EXISTS cbse36ibfirst_event_dates ; CREATE GLOBAL TEMPORARY TABLE cbse36ibfirst_event_dates  (person_id BIGINT,
    from_event VARCHAR(10),
...
DROP TABLE IF EXISTS cbse36ibpatient_timing_pairs_first_to_closest ; CREATE GLOBAL TEMPORARY TABLE cbse36ibpatient_timing_pairs_first_to_closest  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
DROP TABLE IF EXISTS cbse36ibtiming_pair_summary_first_to_closest ; CREATE GLOBAL TEMPORARY TABLE cbse36ibtiming_pair_summary_first_to_closest  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
DROP TABLE IF EXISTS cbse36ibpatient_timing_pairs_first_to_closest_before ; CREATE GLOBAL TEMPORARY TABLE cbse36ibpatient_timing_pairs_first_to_closest_before  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
DROP TABLE IF EXISTS cbse36ibtiming_pair_summary_first_to_closest_before ; CREATE GLOBAL TEMPORARY TABLE cbse36ibtiming_pair_summary_first_to_closest_before  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
DROP TABLE IF EXISTS cbse36ibpatient_timing_pairs_first_to_closest_after ; CREATE GLOBAL TEMPORARY TABLE cbse36ibpatient_timing_pairs_first_to_closest_after  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
DROP TABLE IF EXISTS cbse36ibtiming_pair_summary_first_to_closest_after ; CREATE GLOBAL TEMPORARY TABLE cbse36ibtiming_pair_summary_first_to_closest_after  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
DROP TABLE IF EXISTS cbse36ibevent_presence ; CREATE GLOBAL TEMPORARY TABLE cbse36ibevent_presence  (person_id BIGINT,
    has_dx INT,
    has_odx INT,
    has_gdx INT,
    has_met INT,
...
DROP TABLE IF EXISTS cbse36ibdeath_obs_status ; CREATE GLOBAL TEMPORARY TABLE cbse36ibdeath_obs_status  (person_id BIGINT,
    death_date DATE,
...
DROP TABLE IF EXISTS cbse36ibdeath_index_long ; CREATE GLOBAL TEMPORARY TABLE cbse36ibdeath_index_long  (prevalence_year VARCHAR(20),
    days_to_death INT
);
...
DROP TABLE IF EXISTS cbse36ibdeath_first_met_long ; CREATE GLOBAL TEMPORARY TABLE cbse36ibdeath_first_met_long  (prevalence_year VARCHAR(20),
    days_to_death INT
);
...
DROP TABLE IF EXISTS cbse36ibdeath_stratum_counts ; CREATE GLOBAL TEMPORARY TABLE cbse36ibdeath_stratum_counts  (prevalence_year VARCHAR(20),
...
DROP TABLE IF EXISTS cbse36ibdeath_timing_long ; CREATE GLOBAL TEMPORARY TABLE cbse36ibdeath_timing_long  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    days_to_death INT
);
...
DROP TABLE IF EXISTS cbse36ibdeath_timing_quantiles ; CREATE GLOBAL TEMPORARY TABLE cbse36ibdeath_timing_quantiles  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    lq_days FLOAT,
    median_days FLOAT,
    uq_days FLOAT
...
DROP TABLE IF EXISTS cbse36ibfollowup_long ; CREATE GLOBAL TEMPORARY TABLE cbse36ibfollowup_long  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    followup_days INT
);
...
DROP TABLE IF EXISTS cbse36ibfollowup_quantiles ; CREATE GLOBAL TEMPORARY TABLE cbse36ibfollowup_quantiles  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
...
DROP TABLE IF EXISTS cbse36ibl01_event_days ; CREATE GLOBAL TEMPORARY TABLE cbse36ibl01_event_days  (person_id  BIGINT,
    event_day  DATE
);
...
DROP TABLE IF EXISTS cbse36ibl01_consecutive_gaps ; CREATE GLOBAL TEMPORARY TABLE cbse36ibl01_consecutive_gaps  (person_id  BIGINT,
    subgroup   VARCHAR(10),
    gap_days   INT
);
WITH ranked AS (
...
FROM (
    SELECT 'first_to_first'          AS timing_type, from_event, to_event, n_patients_with_pair, p05_days, p10_days, p20_days, p25_days, p30_days, p40_days, p50_days, p60_days, p70_days, p75_days, p80_days, p90_days, p95_days FROM cbse36ibtiming_pair_summary
    UNION ALL
    SELECT 'first_to_closest'        AS timing_type, from_event, to_event, n_patients_with_pair, p05_days, p10_days, p20_days, p25_days, p30_days, p40_days, p50_days, p60_days, p70_days, p75_days, p80_days, p90_days, p95_days FROM cbse36ibtiming_pair_summary_first_to_closest
    UNION ALL
    SELECT 'first_to_closest_before' AS timing_type, from_event, to_event, n_patients_with_pair, p05_days, p10_days, p20_days, p25_days, p30_days, p40_days, p50_days, p60_days, p70_days, p75_days, p80_days, p90_days, p95_days FROM cbse36ibtiming_pair_summary_first_to_closest_before
    UNION ALL
    SELECT 'first_to_closest_after'  AS timing_type, from_event, to_event, n_patients_with_pair, p05_days, p10_days, p20_days, p25_days, p30_days, p40_days, p50_days, p60_days, p70_days, p75_days, p80_days, p90_days, p95_days FROM cbse36ibtiming_pair_summary_first_to_closest_after
) x
