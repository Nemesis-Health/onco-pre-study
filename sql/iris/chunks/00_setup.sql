...
DROP TABLE IF EXISTS ctxb0womdx_anchor_include ; CREATE GLOBAL TEMPORARY TABLE ctxb0womdx_anchor_include  (concept_id BIGINT NOT NULL,
...
DROP TABLE IF EXISTS ctxb0womdx_anchor_exclude ; CREATE GLOBAL TEMPORARY TABLE ctxb0womdx_anchor_exclude  (concept_id BIGINT NOT NULL,
    include_descendants SMALLINT NOT NULL
);
...
DROP TABLE IF EXISTS ctxb0womdx_anchor_concepts ; CREATE GLOBAL TEMPORARY TABLE ctxb0womdx_anchor_concepts  (concept_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0womgen_cancer_concepts ; CREATE GLOBAL TEMPORARY TABLE ctxb0womgen_cancer_concepts  (concept_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0womother_dx_ancestor_concepts ; CREATE GLOBAL TEMPORARY TABLE ctxb0womother_dx_ancestor_concepts  (ancestor_concept_id BIGINT
);
-- EDIT THIS LIST
...
DROP TABLE IF EXISTS ctxb0womother_dx_concepts ; CREATE GLOBAL TEMPORARY TABLE ctxb0womother_dx_concepts  (concept_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0wommet_ancestor_concepts ; CREATE GLOBAL TEMPORARY TABLE ctxb0wommet_ancestor_concepts  (ancestor_concept_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0wommet_concepts ; CREATE GLOBAL TEMPORARY TABLE ctxb0wommet_concepts  (concept_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0woml01_ancestor_concepts ; CREATE GLOBAL TEMPORARY TABLE ctxb0woml01_ancestor_concepts  (ancestor_concept_id BIGINT
);
-- EDIT THIS LIST
...
DROP TABLE IF EXISTS ctxb0woml01_concepts ; CREATE GLOBAL TEMPORARY TABLE ctxb0woml01_concepts  (concept_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0womdx_events ; CREATE GLOBAL TEMPORARY TABLE ctxb0womdx_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0womanchor_person ; CREATE GLOBAL TEMPORARY TABLE ctxb0womanchor_person  (person_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0womother_dx_events ; CREATE GLOBAL TEMPORARY TABLE ctxb0womother_dx_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0womgen_cancer_events ; CREATE GLOBAL TEMPORARY TABLE ctxb0womgen_cancer_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0wommet_events ; CREATE GLOBAL TEMPORARY TABLE ctxb0wommet_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0woml01_events ; CREATE GLOBAL TEMPORARY TABLE ctxb0woml01_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0woml01_ingredient_events ; CREATE GLOBAL TEMPORARY TABLE ctxb0woml01_ingredient_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
DROP TABLE IF EXISTS ctxb0womcohort_attrition ; CREATE GLOBAL TEMPORARY TABLE ctxb0womcohort_attrition  (stage      VARCHAR(50),
    n_patients INT
);
...
DROP TABLE IF EXISTS ctxb0womcohort ; CREATE GLOBAL TEMPORARY TABLE ctxb0womcohort  (person_id BIGINT,
    index_date DATE
);
...
DROP TABLE IF EXISTS ctxb0womdx_summary ; CREATE GLOBAL TEMPORARY TABLE ctxb0womdx_summary  (person_id BIGINT,
    n_dx_records INT,
    n_dx_codes INT
);
...
DROP TABLE IF EXISTS ctxb0womother_dx_summary ; CREATE GLOBAL TEMPORARY TABLE ctxb0womother_dx_summary  (person_id BIGINT,
...
DROP TABLE IF EXISTS ctxb0womgen_cancer_summary ; CREATE GLOBAL TEMPORARY TABLE ctxb0womgen_cancer_summary  (person_id BIGINT,
...
DROP TABLE IF EXISTS ctxb0wommet_summary ; CREATE GLOBAL TEMPORARY TABLE ctxb0wommet_summary  (person_id BIGINT,
    first_met_date DATE,
    n_met_records INT
);
...
DROP TABLE IF EXISTS ctxb0woml01_summary ; CREATE GLOBAL TEMPORARY TABLE ctxb0woml01_summary  (person_id BIGINT,
    first_l01_date DATE,
    n_l01_exposures INT
);
...
DROP TABLE IF EXISTS ctxb0womevent_code_counts ; CREATE GLOBAL TEMPORARY TABLE ctxb0womevent_code_counts  (anchor_event VARCHAR(20), -- INDEX or FIRST_MET
...
DROP TABLE IF EXISTS ctxb0womevent_code_counts_before_after ; CREATE GLOBAL TEMPORARY TABLE ctxb0womevent_code_counts_before_after  (anchor_event VARCHAR(20), -- INDEX
    event_family VARCHAR(20),
...
DROP TABLE IF EXISTS ctxb0womevent_code_counts_before_after_first_met ; CREATE GLOBAL TEMPORARY TABLE ctxb0womevent_code_counts_before_after_first_met  (anchor_event VARCHAR(20), -- FIRST_MET
    event_family VARCHAR(20),
...
DROP TABLE IF EXISTS ctxb0womevent_code_all_events ; CREATE GLOBAL TEMPORARY TABLE ctxb0womevent_code_all_events  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT,
...
DROP TABLE IF EXISTS ctxb0womevent_code_patient_chosen_first ; CREATE GLOBAL TEMPORARY TABLE ctxb0womevent_code_patient_chosen_first  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT
...
DROP TABLE IF EXISTS ctxb0womevent_code_patient_chosen_closest ; CREATE GLOBAL TEMPORARY TABLE ctxb0womevent_code_patient_chosen_closest  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT
...
DROP TABLE IF EXISTS ctxb0womevent_code_timing_summary ; CREATE GLOBAL TEMPORARY TABLE ctxb0womevent_code_timing_summary  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
...
DROP TABLE IF EXISTS ctxb0womevent_code_ba_events ; CREATE GLOBAL TEMPORARY TABLE ctxb0womevent_code_ba_events  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
...
DROP TABLE IF EXISTS ctxb0womevent_code_patient_chosen_before_after_first ; CREATE GLOBAL TEMPORARY TABLE ctxb0womevent_code_patient_chosen_before_after_first  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    person_id BIGINT,
...
DROP TABLE IF EXISTS ctxb0womevent_code_patient_chosen_before_after_closest ; CREATE GLOBAL TEMPORARY TABLE ctxb0womevent_code_patient_chosen_before_after_closest  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    person_id BIGINT,
...
DROP TABLE IF EXISTS ctxb0womevent_code_timing_before_after_summary ; CREATE GLOBAL TEMPORARY TABLE ctxb0womevent_code_timing_before_after_summary  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    n_patients_with_code_timing INT,
...
DROP TABLE IF EXISTS ctxb0wompatient_char ; CREATE GLOBAL TEMPORARY TABLE ctxb0wompatient_char  (person_id BIGINT,
    index_date DATE,
    n_dx_records INT,
    n_dx_codes INT,
    first_other_dx_date DATE,
...
DROP TABLE IF EXISTS ctxb0wompatient_timing_pairs ; CREATE GLOBAL TEMPORARY TABLE ctxb0wompatient_timing_pairs  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
WITH events AS (
    SELECT person_id, 'DX' AS event_name, index_date AS event_date FROM ctxb0wompatient_char
    UNION ALL
...
DROP TABLE IF EXISTS ctxb0womtiming_pair_summary ; CREATE GLOBAL TEMPORARY TABLE ctxb0womtiming_pair_summary  (from_event VARCHAR(10),
    to_event VARCHAR(10),
...
DROP TABLE IF EXISTS ctxb0womall_events_for_pairs ; CREATE GLOBAL TEMPORARY TABLE ctxb0womall_events_for_pairs  (person_id BIGINT,
...
DROP TABLE IF EXISTS ctxb0womfirst_event_dates ; CREATE GLOBAL TEMPORARY TABLE ctxb0womfirst_event_dates  (person_id BIGINT,
    from_event VARCHAR(10),
...
DROP TABLE IF EXISTS ctxb0wompatient_timing_pairs_first_to_closest ; CREATE GLOBAL TEMPORARY TABLE ctxb0wompatient_timing_pairs_first_to_closest  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
DROP TABLE IF EXISTS ctxb0womtiming_pair_summary_first_to_closest ; CREATE GLOBAL TEMPORARY TABLE ctxb0womtiming_pair_summary_first_to_closest  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
DROP TABLE IF EXISTS ctxb0wompatient_timing_pairs_first_to_closest_before ; CREATE GLOBAL TEMPORARY TABLE ctxb0wompatient_timing_pairs_first_to_closest_before  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
DROP TABLE IF EXISTS ctxb0womtiming_pair_summary_first_to_closest_before ; CREATE GLOBAL TEMPORARY TABLE ctxb0womtiming_pair_summary_first_to_closest_before  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
DROP TABLE IF EXISTS ctxb0wompatient_timing_pairs_first_to_closest_after ; CREATE GLOBAL TEMPORARY TABLE ctxb0wompatient_timing_pairs_first_to_closest_after  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
DROP TABLE IF EXISTS ctxb0womtiming_pair_summary_first_to_closest_after ; CREATE GLOBAL TEMPORARY TABLE ctxb0womtiming_pair_summary_first_to_closest_after  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
DROP TABLE IF EXISTS ctxb0womevent_presence ; CREATE GLOBAL TEMPORARY TABLE ctxb0womevent_presence  (person_id BIGINT,
    has_dx INT,
    has_odx INT,
    has_gdx INT,
    has_met INT,
...
DROP TABLE IF EXISTS ctxb0womdeath_obs_status ; CREATE GLOBAL TEMPORARY TABLE ctxb0womdeath_obs_status  (person_id BIGINT,
    death_date DATE,
...
DROP TABLE IF EXISTS ctxb0womdeath_index_long ; CREATE GLOBAL TEMPORARY TABLE ctxb0womdeath_index_long  (prevalence_year VARCHAR(20),
    days_to_death INT
);
...
DROP TABLE IF EXISTS ctxb0womdeath_first_met_long ; CREATE GLOBAL TEMPORARY TABLE ctxb0womdeath_first_met_long  (prevalence_year VARCHAR(20),
    days_to_death INT
);
...
DROP TABLE IF EXISTS ctxb0womdeath_stratum_counts ; CREATE GLOBAL TEMPORARY TABLE ctxb0womdeath_stratum_counts  (prevalence_year VARCHAR(20),
...
DROP TABLE IF EXISTS ctxb0womdeath_timing_long ; CREATE GLOBAL TEMPORARY TABLE ctxb0womdeath_timing_long  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    days_to_death INT
);
...
DROP TABLE IF EXISTS ctxb0womdeath_timing_quantiles ; CREATE GLOBAL TEMPORARY TABLE ctxb0womdeath_timing_quantiles  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    lq_days FLOAT,
    median_days FLOAT,
    uq_days FLOAT
...
DROP TABLE IF EXISTS ctxb0womfollowup_long ; CREATE GLOBAL TEMPORARY TABLE ctxb0womfollowup_long  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    followup_days INT
);
...
DROP TABLE IF EXISTS ctxb0womfollowup_quantiles ; CREATE GLOBAL TEMPORARY TABLE ctxb0womfollowup_quantiles  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
...
DROP TABLE IF EXISTS ctxb0woml01_event_days ; CREATE GLOBAL TEMPORARY TABLE ctxb0woml01_event_days  (person_id  BIGINT,
    event_day  DATE
);
...
DROP TABLE IF EXISTS ctxb0woml01_consecutive_gaps ; CREATE GLOBAL TEMPORARY TABLE ctxb0woml01_consecutive_gaps  (person_id  BIGINT,
    subgroup   VARCHAR(12),
    gap_days   INT
);
WITH ranked AS (
