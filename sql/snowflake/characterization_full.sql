...
CREATE TEMP TABLE a9of9doxdx_anchor_include  (concept_id BIGINT NOT NULL,
...
CREATE TEMP TABLE a9of9doxdx_anchor_exclude  (concept_id BIGINT NOT NULL,
    include_descendants SMALLINT NOT NULL
);
...
CREATE TEMP TABLE a9of9doxdx_anchor_concepts  (concept_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxgen_cancer_concepts  (concept_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxother_dx_ancestor_concepts  (ancestor_concept_id BIGINT
);
-- EDIT THIS LIST
...
CREATE TEMP TABLE a9of9doxother_dx_concepts  (concept_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxmet_ancestor_concepts  (ancestor_concept_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxmet_concepts  (concept_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxl01_ancestor_concepts  (ancestor_concept_id BIGINT
);
-- EDIT THIS LIST
...
CREATE TEMP TABLE a9of9doxl01_concepts  (concept_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxdx_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxanchor_person  (person_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxother_dx_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxgen_cancer_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxmet_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxl01_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxl01_ingredient_events  (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
);
...
CREATE TEMP TABLE a9of9doxcohort_attrition  (stage      VARCHAR(50),
    n_patients INT
);
...
CREATE TEMP TABLE a9of9doxcohort  (person_id BIGINT,
    index_date DATE
);
...
CREATE TEMP TABLE a9of9doxdx_summary  (person_id BIGINT,
    n_dx_records INT,
    n_dx_codes INT
);
...
CREATE TEMP TABLE a9of9doxother_dx_summary  (person_id BIGINT,
...
CREATE TEMP TABLE a9of9doxgen_cancer_summary  (person_id BIGINT,
...
CREATE TEMP TABLE a9of9doxmet_summary  (person_id BIGINT,
    first_met_date DATE,
    n_met_records INT
);
...
CREATE TEMP TABLE a9of9doxl01_summary  (person_id BIGINT,
    first_l01_date DATE,
    n_l01_exposures INT
);
...
CREATE TEMP TABLE a9of9doxevent_code_counts  (anchor_event VARCHAR(20), -- INDEX or FIRST_MET
...
CREATE TEMP TABLE a9of9doxevent_code_counts_before_after  (anchor_event VARCHAR(20), -- INDEX
    event_family VARCHAR(20),
...
CREATE TEMP TABLE a9of9doxevent_code_counts_before_after_first_met  (anchor_event VARCHAR(20), -- FIRST_MET
    event_family VARCHAR(20),
...
CREATE TEMP TABLE a9of9doxevent_code_all_events  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT,
...
CREATE TEMP TABLE a9of9doxevent_code_patient_chosen_first  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT
...
CREATE TEMP TABLE a9of9doxevent_code_patient_chosen_closest  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
    person_id BIGINT,
    days_diff INT
...
CREATE TEMP TABLE a9of9doxevent_code_timing_summary  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
...
CREATE TEMP TABLE a9of9doxevent_code_ba_events  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
...
CREATE TEMP TABLE a9of9doxevent_code_patient_chosen_before_after_first  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    person_id BIGINT,
...
CREATE TEMP TABLE a9of9doxevent_code_patient_chosen_before_after_closest  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    person_id BIGINT,
...
CREATE TEMP TABLE a9of9doxevent_code_timing_before_after_summary  (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    n_patients_with_code_timing INT,
...
CREATE TEMP TABLE a9of9doxpatient_char  (person_id BIGINT,
    index_date DATE,
    n_dx_records INT,
    n_dx_codes INT,
    first_other_dx_date DATE,
...
CREATE TEMP TABLE a9of9doxpatient_timing_pairs  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
INSERT INTO a9of9doxpatient_timing_pairs (person_id, from_event, to_event, days_diff)
 WITH events  AS (SELECT person_id,  CAST('DX' as TEXT) AS event_name, index_date AS event_date FROM a9of9doxpatient_char
    UNION ALL
...
CREATE TEMP TABLE a9of9doxtiming_pair_summary  (from_event VARCHAR(10),
    to_event VARCHAR(10),
...
CREATE TEMP TABLE a9of9doxall_events_for_pairs  (person_id BIGINT,
...
CREATE TEMP TABLE a9of9doxfirst_event_dates  (person_id BIGINT,
    from_event VARCHAR(10),
...
CREATE TEMP TABLE a9of9doxpatient_timing_pairs_first_to_closest  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
CREATE TEMP TABLE a9of9doxtiming_pair_summary_first_to_closest  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
CREATE TEMP TABLE a9of9doxpatient_timing_pairs_first_to_closest_before  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
CREATE TEMP TABLE a9of9doxtiming_pair_summary_first_to_closest_before  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
CREATE TEMP TABLE a9of9doxpatient_timing_pairs_first_to_closest_after  (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
...
CREATE TEMP TABLE a9of9doxtiming_pair_summary_first_to_closest_after  (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
CREATE TEMP TABLE a9of9doxevent_presence  (person_id BIGINT,
    has_dx INT,
    has_odx INT,
    has_gdx INT,
    has_met INT,
...
CREATE TEMP TABLE a9of9doxdeath_obs_status  (person_id BIGINT,
    death_date DATE,
...
CREATE TEMP TABLE a9of9doxdeath_index_long  (prevalence_year VARCHAR(20),
    days_to_death INT
);
...
CREATE TEMP TABLE a9of9doxdeath_first_met_long  (prevalence_year VARCHAR(20),
    days_to_death INT
);
...
CREATE TEMP TABLE a9of9doxdeath_stratum_counts  (prevalence_year VARCHAR(20),
...
CREATE TEMP TABLE a9of9doxdeath_timing_long  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    days_to_death INT
);
...
CREATE TEMP TABLE a9of9doxdeath_timing_quantiles  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    lq_days FLOAT,
    median_days FLOAT,
    uq_days FLOAT
...
CREATE TEMP TABLE a9of9doxfollowup_long  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    followup_days INT
);
...
CREATE TEMP TABLE a9of9doxfollowup_quantiles  (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
...
CREATE TEMP TABLE a9of9doxl01_event_days  (person_id  BIGINT,
    event_day  DATE
);
...
CREATE TEMP TABLE a9of9doxl01_consecutive_gaps  (person_id  BIGINT,
    subgroup   VARCHAR(12),
    gap_days   INT
);
