...
-- Translated     : 2026-05-06 18:36:43 BST
...
------------------------------------------------------------
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6dx_anchor_include';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6dx_anchor_include';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6dx_anchor_include (
    concept_id NUMBER(19) NOT NULL,
    include_descendants SMALLINT NOT NULL
);
INSERT ALL
INTO ldpw47q6dx_anchor_include        (concept_id, include_descendants) VALUES (INTO ldpw47q6dx_anchor_include      (concept_id, include_descendants) VALUES (INTO ldpw47q6dx_anchor_include    (concept_id, include_descendants) VALUES (INTO ldpw47q6dx_anchor_include  (concept_id, include_descendants) VALUES (197508, 1)
 INTO ldpw47q6dx_anchor_include  (concept_id, include_descendants) VALUES (4181357, 1)
)
 INTO ldpw47q6dx_anchor_include   (concept_id, include_descendants) VALUES (4177230, 1)
)
 INTO ldpw47q6dx_anchor_include    (concept_id, include_descendants) VALUES (37163176, 1)
)
 INTO ldpw47q6dx_anchor_include     (concept_id, include_descendants) VALUES (4178972, 1)
)
 INTO ldpw47q6dx_anchor_include      (concept_id, include_descendants) VALUES (4091486, 0)
)
 INTO ldpw47q6dx_anchor_include       (concept_id, include_descendants) VALUES (44501785, 0)
)
 INTO ldpw47q6dx_anchor_include        (concept_id, include_descendants) VALUES (37110270, 1)
SELECT *   FROM DUAL;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6dx_anchor_exclude';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6dx_anchor_exclude';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6dx_anchor_exclude (
    concept_id NUMBER(19) NOT NULL,
    include_descendants SMALLINT NOT NULL
);
INSERT ALL
INTO ldpw47q6dx_anchor_exclude         (concept_id, include_descendants) VALUES (INTO ldpw47q6dx_anchor_exclude       (concept_id, include_descendants) VALUES (INTO ldpw47q6dx_anchor_exclude     (concept_id, include_descendants) VALUES (INTO ldpw47q6dx_anchor_exclude   (concept_id, include_descendants) VALUES (4280899, 1)
 INTO ldpw47q6dx_anchor_exclude  (concept_id, include_descendants) VALUES (4289374, 1)
)
 INTO ldpw47q6dx_anchor_exclude   (concept_id, include_descendants) VALUES (4280900, 1)
)
 INTO ldpw47q6dx_anchor_exclude    (concept_id, include_descendants) VALUES (4283614, 1)
)
 INTO ldpw47q6dx_anchor_exclude     (concept_id, include_descendants) VALUES (4289097, 1)
)
 INTO ldpw47q6dx_anchor_exclude      (concept_id, include_descendants) VALUES (4280901, 1)
)
 INTO ldpw47q6dx_anchor_exclude       (concept_id, include_descendants) VALUES (4289376, 1)
)
 INTO ldpw47q6dx_anchor_exclude        (concept_id, include_descendants) VALUES (4280897, 1)
)
 INTO ldpw47q6dx_anchor_exclude         (concept_id, include_descendants) VALUES (4200889, 1)
SELECT *   FROM DUAL;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6dx_anchor_concepts';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6dx_anchor_concepts';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6dx_anchor_concepts (
    concept_id NUMBER(19)
);
INSERT INTO ldpw47q6dx_anchor_concepts (concept_id)
SELECT DISTINCT ca.descendant_concept_id
FROM ldpw47q6dx_anchor_include i
...
DELETE FROM ldpw47q6dx_anchor_concepts
WHERE EXISTS (SELECT 1
    FROM ldpw47q6dx_anchor_exclude e
    JOIN @cdm_database_schema.concept_ancestor ca
      ON ca.ancestor_concept_id = e.concept_id
     AND ldpw47q6dx_anchor_concepts.concept_id = ca.descendant_concept_id
...
------------------------------------------------------------
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6gen_cancer_concepts';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6gen_cancer_concepts';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6gen_cancer_concepts (
    concept_id NUMBER(19)
);
INSERT INTO ldpw47q6gen_cancer_concepts (concept_id)
SELECT DISTINCT ca.ancestor_concept_id
FROM @cdm_database_schema.concept_ancestor ca
JOIN ldpw47q6dx_anchor_concepts d
...
JOIN @cdm_database_schema.concept_ancestor malign
 ...
 AND malign.descendant_concept_id = ca.ancestor_concept_id
  WHERE NOT EXISTS (SELECT 1
    FROM ldpw47q6dx_anchor_concepts dx
...
------------------------------------------------------------
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6other_dx_ancestor_concepts';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6other_dx_ancestor_concepts';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6other_dx_ancestor_concepts (
    ancestor_concept_id NUMBER(19)
);
-- EDIT THIS LIST
INSERT INTO ldpw47q6other_dx_ancestor_concepts (ancestor_concept_id)
VALUES
    (443392) -- Malignant neoplastic disease
;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6other_dx_concepts';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6other_dx_concepts';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6other_dx_concepts (
    concept_id NUMBER(19)
);
INSERT INTO ldpw47q6other_dx_concepts (concept_id)
SELECT DISTINCT ca.descendant_concept_id
FROM @cdm_database_schema.concept_ancestor ca
JOIN ldpw47q6other_dx_ancestor_concepts a
  ON ca.ancestor_concept_id = a.ancestor_concept_id
LEFT JOIN ldpw47q6dx_anchor_concepts dx
  ON dx.concept_id = ca.descendant_concept_id
LEFT JOIN ldpw47q6gen_cancer_concepts gdx
...
------------------------------------------------------------
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6met_ancestor_concepts';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6met_ancestor_concepts';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6met_ancestor_concepts (
    ancestor_concept_id NUMBER(19)
);
-- Default: concept set "Secondary malignancy" from cohort_definitions/Target_Cohort_2B.json
INSERT ALL
INTO ldpw47q6met_ancestor_concepts   (ancestor_concept_id) VALUES (1633308)
 INTO ldpw47q6met_ancestor_concepts  (ancestor_concept_id) VALUES (1635142)
)
 INTO ldpw47q6met_ancestor_concepts   (ancestor_concept_id) VALUES (36769180)
SELECT *   FROM DUAL;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6met_concepts';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6met_concepts';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6met_concepts (
    concept_id NUMBER(19)
);
INSERT INTO ldpw47q6met_concepts (concept_id)
SELECT DISTINCT ca.descendant_concept_id
FROM @cdm_database_schema.concept_ancestor ca
JOIN ldpw47q6met_ancestor_concepts a
  ON ca.ancestor_concept_id = a.ancestor_concept_id
 ;
------------------------------------------------------------
...
------------------------------------------------------------
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6l01_ancestor_concepts';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6l01_ancestor_concepts';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6l01_ancestor_concepts (
    ancestor_concept_id NUMBER(19)
);
-- EDIT THIS LIST
INSERT INTO ldpw47q6l01_ancestor_concepts (ancestor_concept_id)
VALUES
    (21601387)
;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6l01_concepts';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6l01_concepts';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6l01_concepts (
    concept_id NUMBER(19)
);
INSERT INTO ldpw47q6l01_concepts (concept_id)
SELECT DISTINCT ca.descendant_concept_id
FROM @cdm_database_schema.concept_ancestor ca
JOIN ldpw47q6l01_ancestor_concepts a
  ON ca.ancestor_concept_id = a.ancestor_concept_id
 ;
------------------------------------------------------------
-- F) EVENT TABLES
------------------------------------------------------------
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6dx_events';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6dx_events';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6dx_events (
    person_id NUMBER(19),
    event_date DATE,
    concept_id NUMBER(19)
);
INSERT INTO ldpw47q6dx_events (person_id, event_date, concept_id)
SELECT co.person_id,
...
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6anchor_person';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6anchor_person';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6anchor_person (
    person_id NUMBER(19)
);
INSERT INTO ldpw47q6anchor_person (person_id)
SELECT DISTINCT person_id
FROM ldpw47q6dx_events
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6other_dx_events';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6other_dx_events';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6other_dx_events (
    person_id NUMBER(19),
    event_date DATE,
    concept_id NUMBER(19)
);
INSERT INTO ldpw47q6other_dx_events (person_id, event_date, concept_id)
SELECT co.person_id,
    co.condition_start_date,
    co.condition_concept_id
FROM @cdm_database_schema.condition_occurrence co
JOIN ldpw47q6anchor_person ap
  ON co.person_id = ap.person_id
JOIN ldpw47q6other_dx_concepts d
  ON co.condition_concept_id = d.concept_id
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6gen_cancer_events';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6gen_cancer_events';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6gen_cancer_events (
    person_id NUMBER(19),
    event_date DATE,
    concept_id NUMBER(19)
);
INSERT INTO ldpw47q6gen_cancer_events (person_id, event_date, concept_id)
SELECT co.person_id,
    co.condition_start_date,
    co.condition_concept_id
FROM @cdm_database_schema.condition_occurrence co
JOIN ldpw47q6anchor_person ap
  ON co.person_id = ap.person_id
JOIN ldpw47q6gen_cancer_concepts g
  ON co.condition_concept_id = g.concept_id
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6met_events';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6met_events';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6met_events (
    person_id NUMBER(19),
    event_date DATE,
    concept_id NUMBER(19)
);
INSERT INTO ldpw47q6met_events (person_id, event_date, concept_id)
SELECT m.person_id,
    m.measurement_date,
...
JOIN ldpw47q6met_concepts mc
  ON m.measurement_concept_id = mc.concept_id
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6l01_events';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6l01_events';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6l01_events (
    person_id NUMBER(19),
    event_date DATE,
    concept_id NUMBER(19)
);
INSERT INTO ldpw47q6l01_events (person_id, event_date, concept_id)
SELECT de.person_id,
...
JOIN ldpw47q6l01_concepts l
  ON de.drug_concept_id = l.concept_id
 ;
-- Ingredient-level L01 events used for concept-level code counts/timing.
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6l01_ingredient_events';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6l01_ingredient_events';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6l01_ingredient_events (
    person_id NUMBER(19),
    event_date DATE,
    concept_id NUMBER(19)
);
INSERT INTO ldpw47q6l01_ingredient_events (person_id, event_date, concept_id)
SELECT DISTINCT
    de.person_id,
    de.drug_exposure_start_date,
...
------------------------------------------------------------
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6cohort';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6cohort';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6cohort (
    person_id NUMBER(19),
    index_date DATE
);
INSERT INTO ldpw47q6cohort (person_id, index_date)
SELECT person_id,
...
GROUP BY person_id
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6dx_summary';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6dx_summary';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6dx_summary (
    person_id NUMBER(19),
    n_dx_records INT,
    n_dx_codes INT
);
INSERT INTO ldpw47q6dx_summary (person_id, n_dx_records, n_dx_codes)
SELECT e.person_id,
    COUNT(*) AS n_dx_records,
    COUNT(DISTINCT e.concept_id) AS n_dx_codes
FROM ldpw47q6dx_events e
JOIN ldpw47q6cohort c
  ON e.person_id = c.person_id
GROUP BY e.person_id
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6other_dx_summary';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6other_dx_summary';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6other_dx_summary (
    person_id NUMBER(19),
    first_other_dx_date DATE,
    n_other_dx_records INT,
    n_other_dx_codes INT
);
INSERT INTO ldpw47q6other_dx_summary (person_id, first_other_dx_date, n_other_dx_records, n_other_dx_codes)
SELECT e.person_id,
...
GROUP BY e.person_id
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6gen_cancer_summary';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6gen_cancer_summary';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6gen_cancer_summary (
    person_id NUMBER(19),
    first_gen_cancer_date DATE,
    n_gen_cancer_records INT,
    n_gen_cancer_codes INT
);
INSERT INTO ldpw47q6gen_cancer_summary (person_id, first_gen_cancer_date, n_gen_cancer_records, n_gen_cancer_codes)
SELECT e.person_id,
...
GROUP BY e.person_id
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6met_summary';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6met_summary';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6met_summary (
    person_id NUMBER(19),
    first_met_date DATE,
    n_met_records INT
);
INSERT INTO ldpw47q6met_summary (person_id, first_met_date, n_met_records)
SELECT e.person_id,
    MIN(e.event_date) AS first_met_date,
    COUNT(*) AS n_met_records
FROM ldpw47q6met_events e
JOIN ldpw47q6cohort c
  ON e.person_id = c.person_id
GROUP BY e.person_id
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6l01_summary';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6l01_summary';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6l01_summary (
    person_id NUMBER(19),
    first_l01_date DATE,
    n_l01_exposures INT
);
INSERT INTO ldpw47q6l01_summary (person_id, first_l01_date, n_l01_exposures)
SELECT e.person_id,
    MIN(e.event_date) AS first_l01_date,
    COUNT(*) AS n_l01_exposures
FROM ldpw47q6l01_events e
JOIN ldpw47q6cohort c
  ON e.person_id = c.person_id
GROUP BY e.person_id
 ;
...
------------------------------------------------------------
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6event_code_counts';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6event_code_counts';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6event_code_counts (
...
INSERT INTO ldpw47q6event_code_counts (anchor_event, event_family, concept_id, n_records, n_patients)
...
FROM ldpw47q6l01_ingredient_events e
JOIN ldpw47q6met_summary ms
  ON e.person_id = ms.person_id
  WHERE ms.first_met_date IS NOT NULL
GROUP BY concept_id
                   ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6event_code_counts_before_after';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6event_code_counts_before_after';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6event_code_counts_before_after (
...
INSERT INTO ldpw47q6event_code_counts_before_after (anchor_event, event_family, time_relative, concept_id, n_records, n_patients)
SELECT 'INDEX',
       'DX',
...
GROUP BY CASE WHEN CEIL(CAST(e.event_date AS DATE) - CAST(c.index_date AS DATE)) < 0 THEN 'BEFORE' ELSE 'AFTER'  END ,
    e.concept_id
             GROUP BY 1 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6event_code_counts_before_after_first_met';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6event_code_counts_before_after_first_met';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6event_code_counts_before_after_first_met (
...
INSERT INTO ldpw47q6event_code_counts_before_after_first_met (anchor_event, event_family, time_relative, concept_id, n_records, n_patients)
SELECT 'FIRST_MET',
       'DX',
...
GROUP BY CASE WHEN CEIL(CAST(e.event_date AS DATE) - CAST(ms.first_met_date AS DATE)) < 0 THEN 'BEFORE' ELSE 'AFTER'  END ,
    e.concept_id
             GROUP BY 1 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6event_code_all_events';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6event_code_all_events';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6event_code_all_events (
...
INSERT INTO ldpw47q6event_code_all_events (
...
FROM ldpw47q6dx_events e
JOIN ldpw47q6met_summary ms ON e.person_id = ms.person_id
                        WHERE ms.first_met_date IS NOT NULL
        UNION ALL
...
JOIN ldpw47q6met_summary ms ON e.person_id = ms.person_id
  WHERE ms.first_met_date IS NOT NULL
                   ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6event_code_patient_chosen_first';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6event_code_patient_chosen_first';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6event_code_patient_chosen_first (
    anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id NUMBER(19),
    person_id NUMBER(19),
...
INSERT INTO ldpw47q6event_code_patient_chosen_first (anchor_event, event_family, concept_id, person_id, days_diff)
...
FROM (SELECT anchor_event,
    ...
    FROM ldpw47q6event_code_all_events
 ) x
  WHERE rn = 1
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6event_code_patient_chosen_closest';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6event_code_patient_chosen_closest';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6event_code_patient_chosen_closest (
    anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id NUMBER(19),
    person_id NUMBER(19),
...
INSERT INTO ldpw47q6event_code_patient_chosen_closest (anchor_event, event_family, concept_id, person_id, days_diff)
SELECT anchor_event, event_family, concept_id, person_id, days_diff
FROM (SELECT anchor_event,
        event_family,
        concept_id,
 ...
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6event_code_timing_summary';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6event_code_timing_summary';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6event_code_timing_summary (
    anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id NUMBER(19),
...
INSERT INTO ldpw47q6event_code_timing_summary (
    anchor_event,
    event_family,
    concept_id,
...
FROM (SELECT anchor_event,
    ...
    FROM ldpw47q6event_code_patient_chosen_first
...
INNER JOIN (SELECT anchor_event,
    ...
    FROM ldpw47q6event_code_patient_chosen_closest
    GROUP BY anchor_event, event_family, concept_id
 ) k
 ...
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6event_code_ba_events';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6event_code_ba_events';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6event_code_ba_events (
    anchor_event VARCHAR(20),
    event_family VARCHAR(20),
...
INSERT INTO ldpw47q6event_code_ba_events (
...
FROM ldpw47q6event_code_all_events
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6event_code_patient_chosen_before_after_first';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6event_code_patient_chosen_before_after_first';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6event_code_patient_chosen_before_after_first (
    anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id NUMBER(19),
...
INSERT INTO ldpw47q6event_code_patient_chosen_before_after_first (
...
FROM (SELECT anchor_event,
    ...
    FROM ldpw47q6event_code_ba_events
 ) x
  WHERE rn = 1
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6event_code_patient_chosen_before_after_closest';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6event_code_patient_chosen_before_after_closest';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6event_code_patient_chosen_before_after_closest (
    anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id NUMBER(19),
...
INSERT INTO ldpw47q6event_code_patient_chosen_before_after_closest (
    anchor_event, event_family, time_relative, concept_id, person_id, days_diff
)
SELECT anchor_event, event_family, time_relative, concept_id, person_id, days_diff
FROM (SELECT anchor_event,
 ...
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6event_code_timing_before_after_summary';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6event_code_timing_before_after_summary';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6event_code_timing_before_after_summary (
    anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id NUMBER(19),
...
INSERT INTO ldpw47q6event_code_timing_before_after_summary (
    anchor_event,
    event_family,
    time_relative,
    concept_id,
...
FROM (SELECT anchor_event,
        ...
        PERCENTILE_CONT(0.50) WITHIN GROUP (ORDER BY days_diff) AS median_days_first,
        PERCENTILE_CONT(0.75) WITHIN GROUP (ORDER BY days_diff) AS uq_days_first
    FROM ldpw47q6event_code_patient_chosen_before_after_first
...
INNER JOIN (SELECT anchor_event,
        ...
        PERCENTILE_CONT(0.50) WITHIN GROUP (ORDER BY days_diff) AS median_days_closest,
        PERCENTILE_CONT(0.75) WITHIN GROUP (ORDER BY days_diff) AS uq_days_closest
    FROM ldpw47q6event_code_patient_chosen_before_after_closest
    GROUP BY anchor_event, event_family, time_relative, concept_id
 ) k
  ON f.anchor_event = k.anchor_event
 AND f.event_family = k.event_family
...
------------------------------------------------------------
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6patient_char';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6patient_char';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6patient_char (
    person_id NUMBER(19),
    index_date DATE,
    n_dx_records INT,
    n_dx_codes INT,
...
INSERT INTO ldpw47q6patient_char (
    person_id,
    index_date,
    n_dx_records,
    n_dx_codes,
...
LEFT JOIN ldpw47q6dx_summary dx
       ON c.person_id = dx.person_id
LEFT JOIN ldpw47q6other_dx_summary odx
       ON c.person_id = odx.person_id
LEFT JOIN ldpw47q6gen_cancer_summary gdx
       ON c.person_id = gdx.person_id
LEFT JOIN ldpw47q6met_summary mt
       ON c.person_id = mt.person_id
LEFT JOIN ldpw47q6l01_summary l01
...
------------------------------------------------------------
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6patient_timing_pairs';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6patient_timing_pairs';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6patient_timing_pairs (
    person_id NUMBER(19),
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
INSERT INTO ldpw47q6patient_timing_pairs (person_id, from_event, to_event, days_diff)
 WITH events  AS (SELECT person_id, 'DX' AS event_name, index_date AS event_date FROM ldpw47q6patient_char
      UNION ALL
    SELECT person_id, 'ODX', first_other_dx_date FROM ldpw47q6patient_char
      UNION ALL
    SELECT person_id, 'GDX', first_gen_cancer_date FROM ldpw47q6patient_char
      UNION ALL
    SELECT person_id, 'MET', first_met_date FROM ldpw47q6patient_char
      UNION ALL
    SELECT person_id, 'L01', first_l01_date FROM ldpw47q6patient_char
 )
 SELECT e1.person_id,
...
JOIN events e2
 ...
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6timing_pair_summary';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6timing_pair_summary';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6timing_pair_summary (
    from_event VARCHAR(10),
    to_event VARCHAR(10),
...
INSERT INTO ldpw47q6timing_pair_summary (
    from_event,
    to_event,
...
FROM ldpw47q6patient_timing_pairs
GROUP BY from_event, to_event
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6all_events_for_pairs';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6all_events_for_pairs';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6all_events_for_pairs (
    person_id NUMBER(19),
    event_family VARCHAR(10),
    event_date DATE
);
INSERT INTO ldpw47q6all_events_for_pairs (person_id, event_family, event_date)
SELECT person_id, 'DX', event_date FROM ldpw47q6dx_events
  UNION ALL
SELECT person_id, 'ODX', event_date FROM ldpw47q6other_dx_events
  UNION ALL
SELECT person_id, 'GDX', event_date FROM ldpw47q6gen_cancer_events
  UNION ALL
SELECT person_id, 'MET', event_date FROM ldpw47q6met_events
  UNION ALL
SELECT person_id, 'L01', event_date FROM ldpw47q6l01_events
         ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6first_event_dates';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6first_event_dates';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6first_event_dates (
    person_id NUMBER(19),
    from_event VARCHAR(10),
    from_first_date DATE
);
INSERT INTO ldpw47q6first_event_dates (person_id, from_event, from_first_date)
SELECT person_id, 'DX', index_date FROM ldpw47q6patient_char
  UNION ALL
SELECT person_id, 'ODX', first_other_dx_date FROM ldpw47q6patient_char         WHERE first_other_dx_date IS NOT NULL
    UNION ALL
SELECT person_id, 'GDX', first_gen_cancer_date FROM ldpw47q6patient_char     WHERE first_gen_cancer_date IS NOT NULL
   UNION ALL
SELECT person_id, 'MET', first_met_date FROM ldpw47q6patient_char     WHERE first_met_date IS NOT NULL
   UNION ALL
SELECT person_id, 'L01', first_l01_date FROM ldpw47q6patient_char   WHERE first_l01_date IS NOT NULL
         ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6patient_timing_pairs_first_to_closest';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6patient_timing_pairs_first_to_closest';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6patient_timing_pairs_first_to_closest (
    person_id NUMBER(19),
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
INSERT INTO ldpw47q6patient_timing_pairs_first_to_closest (person_id, from_event, to_event, days_diff)
 WITH ranked  AS (SELECT f.person_id,
    ...
    FROM ldpw47q6first_event_dates f
    JOIN ldpw47q6all_events_for_pairs a
...
FROM ranked
 ...
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6timing_pair_summary_first_to_closest';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6timing_pair_summary_first_to_closest';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6timing_pair_summary_first_to_closest (
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
...
INSERT INTO ldpw47q6timing_pair_summary_first_to_closest (
    from_event,
    to_event,
    n_patients_with_pair,
    p05_days,
...
SELECT from_event,
    ...
    PERCENTILE_CONT(0.90) WITHIN GROUP (ORDER BY days_diff) AS p90_days,
    PERCENTILE_CONT(0.95) WITHIN GROUP (ORDER BY days_diff) AS p95_days
FROM ldpw47q6patient_timing_pairs_first_to_closest
GROUP BY from_event, to_event
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6patient_timing_pairs_first_to_closest_before';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6patient_timing_pairs_first_to_closest_before';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6patient_timing_pairs_first_to_closest_before (
    person_id NUMBER(19),
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
INSERT INTO ldpw47q6patient_timing_pairs_first_to_closest_before (person_id, from_event, to_event, days_diff)
...
FROM ranked_before
 ...
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6timing_pair_summary_first_to_closest_before';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6timing_pair_summary_first_to_closest_before';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6timing_pair_summary_first_to_closest_before (
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
...
INSERT INTO ldpw47q6timing_pair_summary_first_to_closest_before (
    from_event,
    to_event,
    n_patients_with_pair,
    p05_days,
...
SELECT from_event,
    ...
    PERCENTILE_CONT(0.90) WITHIN GROUP (ORDER BY days_diff) AS p90_days,
    PERCENTILE_CONT(0.95) WITHIN GROUP (ORDER BY days_diff) AS p95_days
FROM ldpw47q6patient_timing_pairs_first_to_closest_before
GROUP BY from_event, to_event
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6patient_timing_pairs_first_to_closest_after';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6patient_timing_pairs_first_to_closest_after';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6patient_timing_pairs_first_to_closest_after (
    person_id NUMBER(19),
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
);
INSERT INTO ldpw47q6patient_timing_pairs_first_to_closest_after (person_id, from_event, to_event, days_diff)
...
FROM ranked_after
 ...
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6timing_pair_summary_first_to_closest_after';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6timing_pair_summary_first_to_closest_after';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6timing_pair_summary_first_to_closest_after (
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
...
INSERT INTO ldpw47q6timing_pair_summary_first_to_closest_after (
    from_event,
    to_event,
    n_patients_with_pair,
    p05_days,
...
SELECT from_event,
    ...
    PERCENTILE_CONT(0.90) WITHIN GROUP (ORDER BY days_diff) AS p90_days,
    PERCENTILE_CONT(0.95) WITHIN GROUP (ORDER BY days_diff) AS p95_days
FROM ldpw47q6patient_timing_pairs_first_to_closest_after
GROUP BY from_event, to_event
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6event_presence';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6event_presence';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6event_presence (
    person_id NUMBER(19),
    has_dx INT,
    has_odx INT,
    has_gdx INT,
...
INSERT INTO ldpw47q6event_presence (
...
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6death_obs_status';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6death_obs_status';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6death_obs_status (
    person_id NUMBER(19),
    death_date DATE,
    death_in_obs SMALLINT
);
INSERT INTO ldpw47q6death_obs_status (person_id, death_date, death_in_obs)
SELECT d.person_id,
    d.death_date,
...
FROM (SELECT person_id, MIN(death_date) AS death_date
  ...
  WHERE d.person_id IN (SELECT person_id FROM ldpw47q6cohort )
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6death_index_long';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6death_index_long';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6death_index_long (
    prevalence_year VARCHAR(20),
    days_to_death INT
);
INSERT INTO ldpw47q6death_index_long (prevalence_year, days_to_death)
...
INNER JOIN ldpw47q6death_obs_status dos ON dos.person_id = c.person_id
  WHERE dos.death_date >= c.index_date
   ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6death_first_met_long';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6death_first_met_long';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6death_first_met_long (
    prevalence_year VARCHAR(20),
    days_to_death INT
);
INSERT INTO ldpw47q6death_first_met_long (prevalence_year, days_to_death)
SELECT 'OVERALL', CEIL(CAST(dos.death_date AS DATE) - CAST(ms.first_met_date AS DATE))
FROM ldpw47q6cohort c
INNER JOIN ldpw47q6met_summary ms ON c.person_id = ms.person_id AND ms.first_met_date IS NOT NULL
INNER JOIN ldpw47q6death_obs_status dos ON dos.person_id = c.person_id
    WHERE dos.death_date >= ms.first_met_date
   UNION ALL
SELECT CAST(EXTRACT(YEAR FROM c.index_date) AS VARCHAR(4)), CEIL(CAST(dos.death_date AS DATE) - CAST(ms.first_met_date AS DATE))
FROM ldpw47q6cohort c
INNER JOIN ldpw47q6met_summary ms ON c.person_id = ms.person_id AND ms.first_met_date IS NOT NULL
INNER JOIN ldpw47q6death_obs_status dos ON dos.person_id = c.person_id
  WHERE dos.death_date >= ms.first_met_date
   ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6death_stratum_counts';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6death_stratum_counts';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6death_stratum_counts (
    prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    n_patients INT,
    n_deaths INT,
...
INSERT INTO ldpw47q6death_stratum_counts (prevalence_year, anchor_event, n_patients, n_deaths, n_deaths_in_obs, n_deaths_out_obs)
SELECT CASE
...
FROM ldpw47q6cohort c
LEFT JOIN ldpw47q6death_obs_status dos ON dos.person_id = c.person_id
...
GROUP BY GROUPING SETS ((), (EXTRACT(YEAR FROM c.index_date)))
 ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6death_timing_long';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6death_timing_long';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6death_timing_long (
    prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    days_to_death INT
);
INSERT INTO ldpw47q6death_timing_long (prevalence_year, anchor_event, days_to_death)
SELECT prevalence_year, 'INDEX', days_to_death FROM ldpw47q6death_index_long
  UNION ALL
SELECT prevalence_year, 'FIRST_MET', days_to_death FROM ldpw47q6death_first_met_long
   ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6death_timing_quantiles';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6death_timing_quantiles';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6death_timing_quantiles (
    prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    lq_days FLOAT,
    median_days FLOAT,
...
INSERT INTO ldpw47q6death_timing_quantiles (
    prevalence_year,
    anchor_event,
    lq_days,
    median_days,
...
FROM ldpw47q6death_timing_long
...
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6followup_long';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6followup_long';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6followup_long (
    prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    followup_days INT
);
INSERT INTO ldpw47q6followup_long (prevalence_year, anchor_event, followup_days)
...
GROUP BY c.person_id, ms.first_met_date
  UNION ALL
SELECT CAST(EXTRACT(YEAR FROM c.index_date) AS VARCHAR(4)), 'FIRST_MET',
       CEIL(CAST(MAX(op.observation_period_end_date) AS DATE) - CAST(ms.first_met_date AS DATE))
FROM ldpw47q6cohort c
INNER JOIN ldpw47q6met_summary ms ON c.person_id = ms.person_id AND ms.first_met_date IS NOT NULL
INNER JOIN @cdm_database_schema.observation_period op
  ON op.person_id = c.person_id
 AND op.observation_period_end_date >= ms.first_met_date
GROUP BY c.person_id, c.index_date, ms.first_met_date, EXTRACT(YEAR FROM c.index_date)
       ;
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6followup_quantiles';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6followup_quantiles';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6followup_quantiles (
    prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
...
INSERT INTO ldpw47q6followup_quantiles (
    prevalence_year,
    anchor_event,
    lq_followup_days,
...
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6l01_event_days';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6l01_event_days';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6l01_event_days (
    person_id  NUMBER(19),
    event_day  DATE
);
INSERT INTO ldpw47q6l01_event_days (person_id, event_day)
SELECT DISTINCT person_id, event_date
FROM ldpw47q6l01_events
  WHERE person_id IN (SELECT person_id FROM ldpw47q6cohort )
 ;
-- Consecutive gaps between L01 event days per patient
BEGIN
  EXECUTE IMMEDIATE 'TRUNCATE TABLE ldpw47q6l01_consecutive_gaps';
  EXECUTE IMMEDIATE 'DROP TABLE ldpw47q6l01_consecutive_gaps';
EXCEPTION
  WHEN OTHERS THEN
    IF SQLCODE != -942 THEN
      RAISE;
...
EXCEPTION
  WHEN OTHERS THEN
    ...
    END IF;
END;
CREATE TABLE ldpw47q6l01_consecutive_gaps (
    person_id  NUMBER(19),
    subgroup   VARCHAR(10),
    gap_days   INT
);
INSERT INTO ldpw47q6l01_consecutive_gaps (person_id, subgroup, gap_days)
 WITH ranked  AS (SELECT e.person_id,
        e.event_day,
        LEAD(e.event_day) OVER (PARTITION BY e.person_id ORDER BY e.event_day) AS next_day
    FROM ldpw47q6l01_event_days e
 ),
...
FROM gaps g
JOIN ldpw47q6met_summary ms ON g.person_id = ms.person_id AND ms.first_met_date IS NOT NULL
   ;
------------------------------------------------------------
...
FROM (SELECT 'all'    AS time_window, anchor_event, event_family, concept_id, n_records, n_patients FROM ldpw47q6event_code_counts
      UNION ALL
    SELECT 'before'  time_window, anchor_event, event_family, concept_id, n_records, n_patients FROM ldpw47q6event_code_counts_before_after                WHERE time_relative = 'BEFORE'
        UNION ALL
    SELECT 'after'   time_window, anchor_event, event_family, concept_id, n_records, n_patients FROM ldpw47q6event_code_counts_before_after            WHERE time_relative = 'AFTER'
       UNION ALL
    SELECT 'before'  time_window, anchor_event, event_family, concept_id, n_records, n_patients FROM ldpw47q6event_code_counts_before_after_first_met    WHERE time_relative = 'BEFORE'
       UNION ALL
    SELECT 'after'   time_window, anchor_event, event_family, concept_id, n_records, n_patients FROM ldpw47q6event_code_counts_before_after_first_met  WHERE time_relative = 'AFTER'
 ) x
...
met_l01_base AS (SELECT EXTRACT(YEAR FROM index_date) AS index_year_int,
        CASE
...
FROM (SELECT 'first_to_first'          AS timing_type, from_event, to_event, n_patients_with_pair, p05_days, p10_days, p20_days, p25_days, p30_days, p40_days, p50_days, p60_days, p70_days, p75_days, p80_days, p90_days, p95_days FROM ldpw47q6timing_pair_summary
      UNION ALL
    SELECT 'first_to_closest'         timing_type, from_event, to_event, n_patients_with_pair, p05_days, p10_days, p20_days, p25_days, p30_days, p40_days, p50_days, p60_days, p70_days, p75_days, p80_days, p90_days, p95_days FROM ldpw47q6timing_pair_summary_first_to_closest
      UNION ALL
    SELECT 'first_to_closest_before'  timing_type, from_event, to_event, n_patients_with_pair, p05_days, p10_days, p20_days, p25_days, p30_days, p40_days, p50_days, p60_days, p70_days, p75_days, p80_days, p90_days, p95_days FROM ldpw47q6timing_pair_summary_first_to_closest_before
      UNION ALL
    SELECT 'first_to_closest_after'   timing_type, from_event, to_event, n_patients_with_pair, p05_days, p10_days, p20_days, p25_days, p30_days, p40_days, p50_days, p60_days, p70_days, p75_days, p80_days, p90_days, p95_days FROM ldpw47q6timing_pair_summary_first_to_closest_after
 ) x
...
FROM (SELECT 'first_to_first' AS timing_type,
        CAST(EXTRACT(YEAR FROM pc.index_date) AS VARCHAR(4)) AS index_year,
        p.from_event,
        p.to_event,
        COUNT(*) AS n_patients_with_pair,
    ...
    GROUP BY EXTRACT(YEAR FROM pc.index_date), p.from_event, p.to_event
      UNION ALL
    -- first_to_closest_after by year (for MET->L01 post-MET treatment timing)
    SELECT
        'first_to_closest_after'  timing_type,
        CAST(EXTRACT(YEAR FROM pc.index_date) AS VARCHAR(4))  index_year,
        p.from_event,
        p.to_event,
        COUNT(*) AS n_patients_with_pair,
        PERCENTILE_CONT(0.25) WITHIN GROUP (ORDER BY p.days_diff) AS p25_days,
...
WITH odx_gdx_events AS (SELECT 'ODX' AS event_family,
        e.concept_id,
        e.person_id,
...
FROM ldpw47q6death_stratum_counts s
LEFT JOIN ldpw47q6death_timing_quantiles q
  ON s.prevalence_year = q.prevalence_year
 AND s.anchor_event = q.anchor_event
LEFT JOIN ldpw47q6followup_quantiles f
...
SELECT 'FIRST_MET'  anchor_event,
    ...
    SUM(CASE WHEN gap_death_after_obs IS NOT NULL THEN 1 ELSE 0 END)  n_death_after_obs,
    PERCENTILE_CONT(0.25) WITHIN GROUP (ORDER BY gap_death_after_obs) AS lq_gap_days,
    PERCENTILE_CONT(0.50) WITHIN GROUP (ORDER BY gap_death_after_obs) AS median_gap_days,
    PERCENTILE_CONT(0.75) WITHIN GROUP (ORDER BY gap_death_after_obs) AS uq_gap_days,
    PERCENTILE_CONT(0.90) WITHIN GROUP (ORDER BY gap_death_after_obs) AS p90_gap_days
...
SELECT  CASE WHEN gap_death_after_obs <   30 THEN 'lt30d'
