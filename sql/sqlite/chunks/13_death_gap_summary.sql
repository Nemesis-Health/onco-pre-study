...
-- Translated     : 2026-05-06 20:12:54 BST
...
death_obs_gaps AS (
    SELECT
        ...
        CASE
            ...
            WHEN dos.death_date > po.last_obs_end       THEN (JULIANDAY(dos.death_date, 'unixepoch') - JULIANDAY(po.last_obs_end, 'unixepoch'))
            ELSE NULL
...
FROM (
    SELECT death_before_obs, death_no_obs_period, gap_death_after_obs,
