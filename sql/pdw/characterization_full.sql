...
-- Target dialect : pdw
-- Translated     : 2026-07-15 15:36:57 CEST
...
------------------------------------------------------------
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #dx_anchor_include;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #dx_anchor_include   (concept_id BIGINT NOT NULL,
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #dx_anchor_exclude;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #dx_anchor_exclude   (concept_id BIGINT NOT NULL,
    include_descendants SMALLINT NOT NULL
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
INSERT INTO #dx_anchor_exclude (concept_id, include_descendants) VALUES
    ...
    (4280897, 1),
    (4200889, 1);
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #dx_anchor_concepts;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #dx_anchor_concepts   (concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
...
------------------------------------------------------------
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #gen_cancer_concepts;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #gen_cancer_concepts   (concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
...
------------------------------------------------------------
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #other_dx_ancestor_concepts;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #other_dx_ancestor_concepts   (ancestor_concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
-- EDIT THIS LIST
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #other_dx_concepts;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #other_dx_concepts   (concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
...
------------------------------------------------------------
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #met_ancestor_concepts;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #met_ancestor_concepts   (ancestor_concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
...
VALUES
    ...
    (36769180)  -- Metastasis
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #met_concepts;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #met_concepts   (concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
...
------------------------------------------------------------
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #l01_ancestor_concepts;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #l01_ancestor_concepts   (ancestor_concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
-- EDIT THIS LIST
...
VALUES
    (21601387)
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #l01_concepts;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #l01_concepts   (concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
...
------------------------------------------------------------
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #dtp_ancestor_concepts;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #dtp_ancestor_concepts   (ancestor_concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
-- EDIT THIS LIST
...
VALUES
    ...
    (4061650)
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #dtp_concepts;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #dtp_concepts   (concept_id      BIGINT,
...
-- F) EVENT TABLES
------------------------------------------------------------
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #dx_events;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #dx_events   (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
)
...
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #anchor_person;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #anchor_person   (person_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = HASH(person_id));
...
FROM #dx_events
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #other_dx_events;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #other_dx_events   (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = HASH(person_id));
...
JOIN #other_dx_concepts d
  ON co.condition_concept_id = d.concept_id
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #gen_cancer_events;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #gen_cancer_events   (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = HASH(person_id));
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #met_events;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #met_events   (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = HASH(person_id));
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #l01_events;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #l01_events   (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = HASH(person_id));
...
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #l01_ingredient_events;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #l01_ingredient_events   (person_id BIGINT,
    event_date DATE,
    concept_id BIGINT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = HASH(person_id));
...
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #cohort_attrition;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #cohort_attrition   (stage      VARCHAR(50),
    n_patients INT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
INSERT INTO #cohort_attrition (stage, n_patients)
SELECT 'dx_any', COUNT(DISTINCT person_id) FROM #dx_events;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #cohort;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #cohort   (person_id BIGINT,
    index_date DATE
)
WITH (LOCATION = USER_DB, DISTRIBUTION = HASH(person_id));
...
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #dx_summary;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #dx_summary   (person_id BIGINT,
    n_dx_records INT,
    n_dx_codes INT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = HASH(person_id));
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #other_dx_summary;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #other_dx_summary   (person_id BIGINT,
...
GROUP BY e.person_id
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #gen_cancer_summary;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #gen_cancer_summary   (person_id BIGINT,
...
GROUP BY e.person_id
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #met_summary;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #met_summary   (person_id BIGINT,
    first_met_date DATE,
    n_met_records INT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = HASH(person_id));
...
GROUP BY e.person_id
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #l01_summary;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #l01_summary   (person_id BIGINT,
    first_l01_date DATE,
    n_l01_exposures INT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = HASH(person_id));
...
------------------------------------------------------------
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #event_code_counts;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #event_code_counts   (anchor_event VARCHAR(20), -- INDEX or FIRST_MET
...
GROUP BY concept_id
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #event_code_counts_before_after;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #event_code_counts_before_after   (anchor_event VARCHAR(20), -- INDEX
    event_family VARCHAR(20),
...
GROUP BY
    ...
    e.concept_id
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #event_code_counts_before_after_first_met;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #event_code_counts_before_after_first_met   (anchor_event VARCHAR(20), -- FIRST_MET
    event_family VARCHAR(20),
...
GROUP BY
    ...
    e.concept_id
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #event_code_all_events;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #event_code_all_events   (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
     person_id BIGINT,
    days_diff INT,
...
WHERE ms.first_met_date IS NOT NULL
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #event_code_patient_chosen_first;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #event_code_patient_chosen_first   (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
     person_id BIGINT,
    days_diff INT
...
WHERE rn = 1
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #event_code_patient_chosen_closest;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #event_code_patient_chosen_closest   (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
     person_id BIGINT,
    days_diff INT
...
WHERE rn = 1
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #event_code_timing_summary;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #event_code_timing_summary   (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    concept_id BIGINT,
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #event_code_ba_events;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #event_code_ba_events   (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
...
FROM #event_code_all_events
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #event_code_patient_chosen_before_after_first;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #event_code_patient_chosen_before_after_first   (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
     person_id BIGINT,
...
WHERE rn = 1
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #event_code_patient_chosen_before_after_closest;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #event_code_patient_chosen_before_after_closest   (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
     person_id BIGINT,
...
WHERE rn = 1
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #event_code_timing_before_after_summary;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #event_code_timing_before_after_summary   (anchor_event VARCHAR(20),
    event_family VARCHAR(20),
    time_relative VARCHAR(10),
    concept_id BIGINT,
    n_patients_with_code_timing INT,
...
------------------------------------------------------------
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #patient_char;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #patient_char   (person_id BIGINT,
    index_date DATE,
    n_dx_records INT,
    n_dx_codes INT,
    first_other_dx_date DATE,
...
------------------------------------------------------------
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #patient_timing_pairs;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #patient_timing_pairs   (person_id BIGINT,
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #timing_pair_summary;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #timing_pair_summary   (from_event VARCHAR(10),
    to_event VARCHAR(10),
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #all_events_for_pairs;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #all_events_for_pairs   (person_id BIGINT,
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #first_event_dates;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #first_event_dates   (person_id BIGINT,
    from_event VARCHAR(10),
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #patient_timing_pairs_first_to_closest;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #patient_timing_pairs_first_to_closest   (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
)
...
WHERE rn = 1
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #timing_pair_summary_first_to_closest;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #timing_pair_summary_first_to_closest   (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
GROUP BY from_event, to_event
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #patient_timing_pairs_first_to_closest_before;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #patient_timing_pairs_first_to_closest_before   (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
)
...
WHERE rn = 1
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #timing_pair_summary_first_to_closest_before;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #timing_pair_summary_first_to_closest_before   (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
GROUP BY from_event, to_event
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #patient_timing_pairs_first_to_closest_after;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #patient_timing_pairs_first_to_closest_after   (person_id BIGINT,
    from_event VARCHAR(10),
    to_event VARCHAR(10),
    days_diff INT
)
...
WHERE rn = 1
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #timing_pair_summary_first_to_closest_after;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #timing_pair_summary_first_to_closest_after   (from_event VARCHAR(10),
    to_event VARCHAR(10),
    n_patients_with_pair INT,
    p05_days FLOAT,
    p10_days FLOAT,
...
GROUP BY from_event, to_event
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #event_presence;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #event_presence   (person_id BIGINT,
    has_dx INT,
    has_odx INT,
    has_gdx INT,
    has_met INT,
...
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #death_obs_status;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #death_obs_status   (person_id BIGINT,
    death_date DATE,
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #death_index_long;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #death_index_long   (prevalence_year VARCHAR(20),
    days_to_death INT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
...
WHERE dos.death_date >= c.index_date
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #death_first_met_long;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #death_first_met_long   (prevalence_year VARCHAR(20),
    days_to_death INT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
...
WHERE dos.death_date >= ms.first_met_date
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #death_stratum_counts;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #death_stratum_counts   (prevalence_year VARCHAR(20),
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #death_timing_long;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #death_timing_long   (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    days_to_death INT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #death_timing_quantiles;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #death_timing_quantiles   (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    lq_days FLOAT,
    median_days FLOAT,
    uq_days FLOAT
...
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #followup_long;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #followup_long   (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
    followup_days INT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = REPLICATE);
...
;
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #followup_quantiles;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #followup_quantiles   (prevalence_year VARCHAR(20),
    anchor_event VARCHAR(20),
...
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #l01_event_days;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #l01_event_days   (person_id BIGINT,
    event_day  DATE
)
WITH (LOCATION = USER_DB, DISTRIBUTION = HASH(person_id));
...
IF XACT_STATE() = 1 COMMIT; DROP TABLE IF EXISTS #l01_consecutive_gaps;
IF XACT_STATE() = 1 COMMIT; CREATE TABLE #l01_consecutive_gaps   (person_id BIGINT,
    subgroup   VARCHAR(12),
    gap_days   INT
)
WITH (LOCATION = USER_DB, DISTRIBUTION = HASH(person_id));
